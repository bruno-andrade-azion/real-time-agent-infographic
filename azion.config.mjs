...
export default {
  ...
  storage: [
    {
      name: 'whiteboard-real-time-agent',
      prefix: '20260826195042',
      dir: './.edge/assets',
  ...
  connectors: [
    {
      ...
      type: 'storage',
      attributes: {
        bucket: 'whiteboard-real-time-agent',
        prefix: '20260826195042'
      }
    }
  ],
            ...
            behaviors: [
              {
                type: 'set_connector',
                attributes: {
                  value: 'whiteboard-real-time-agent'
                }
              },
              {
      ...
      deployments: [
        {
          ...
          strategy: {
            type: 'default',
            attributes: {
              application: 'whiteboard-real-time-agent'
            }
          }
        }
      ]
